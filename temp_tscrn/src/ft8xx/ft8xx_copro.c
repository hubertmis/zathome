			    ...
			    uint16_t range)
{
	...
	wr32(RAM_CMD + reg_cmd_write, CMD_SLIDER);
                            ...
                            const char* s)
{
    ...
    wr32(RAM_CMD + reg_cmd_write, CMD_TOGGLE);
    ...
    wr16(RAM_CMD + reg_cmd_write, state);
			   ...
			   int16_t tag)
{
	...
	wr32(RAM_CMD + reg_cmd_write, CMD_TRACK);
	...
	wr16(RAM_CMD + reg_cmd_write, tag);
